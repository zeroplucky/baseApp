...
public class CsvFormatStrategy implements FormatStrategy {
    ...
    public static final class Builder {
        private static final int MAX_BYTES = 1024 * 1024; // 1M averages to a 4000 lines per file
        ...
        public CsvFormatStrategy build(Context context) {
            ...
            if (logStrategy == null) {
                ...
                ht.start();
                Handler handler = new DiskLogStrategy.WriteHandler(ht.getLooper(), folder, MAX_BYTES, tag);
