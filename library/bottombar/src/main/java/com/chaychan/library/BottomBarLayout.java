...
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCount; i++) {
            if (getChildAt(i) instanceof BottomBarItem) {
                ...
                //设置点击监听
                bottomBarItem.setOnClickListener(new MyOnClickListener(i, bottomBarItem.mUpdateTabState));
            } else {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        private boolean mUpdateTabState;

        public MyOnClickListener(int i) {
            this.currentIndex = i;
        }

        public MyOnClickListener(int currentIndex, boolean mUpdateTabState) {
            this.currentIndex = currentIndex;
            this.mUpdateTabState = mUpdateTabState;
        }
