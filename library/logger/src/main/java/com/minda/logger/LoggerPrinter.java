...
class LoggerPrinter implements Printer {
    ...
    public void d(@NonNull String message, @Nullable Object... args) {
        log(com.minda.logger.Logger.DEBUG, null, message, args);
    }

    @Override
    public void d(@Nullable Object object) {
        log(com.minda.logger.Logger.DEBUG, null, Utils.toString(object));
    }
    ...
    public void e(@Nullable Throwable throwable, @NonNull String message, @Nullable Object... args) {
        log(com.minda.logger.Logger.ERROR, throwable, message, args);
    }

    @Override
    public void w(@NonNull String message, @Nullable Object... args) {
        log(com.minda.logger.Logger.WARN, null, message, args);
    }

    @Override
    public void i(@NonNull String message, @Nullable Object... args) {
        log(com.minda.logger.Logger.INFO, null, message, args);
    }

    @Override
    public void v(@NonNull String message, @Nullable Object... args) {
        log(com.minda.logger.Logger.VERBOSE, null, message, args);
    }

    @Override
    public void wtf(@NonNull String message, @Nullable Object... args) {
        log(com.minda.logger.Logger.ASSERT, null, message, args);
    }
