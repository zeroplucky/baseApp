...
public class BottomBarItem extends LinearLayout {
    ...
    private int mItemPadding;//BottomBarItem的paddin
    public boolean mUpdateTabState = true;
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, sp2px(mContext, mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, dip2Px(mContext, mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, sp2px(mContext, mUnreadTextSize));
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, sp2px(mContext, mMsgTextSize));
        ...
        //
        mUpdateTabState = ta.getBoolean(R.styleable.BottomBarItem_mUpdateTabState, mUpdateTabState);
    }
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@link BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{@link BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{@link BottomBarItem#unreadNumThreshold}
     *                  显示{@link BottomBarItem#unreadNumThreshold}+
     */
