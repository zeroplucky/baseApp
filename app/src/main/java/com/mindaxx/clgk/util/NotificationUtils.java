...
/**
 * @author yangchong ......blog: https://www.jianshu.com/p/514eb6193a06
 *         参考 https://blog.csdn.net/androidzmm/article/details/80679804
 */
public class NotificationUtils extends ContextWrapper {
     ...
     * 调用该方法可以发送通知
     *
     * @param notifyId notifyId 消息id, 可以通过此id，取消通知.notificationManager.cancel(notifyId);
     * @param title    title
     * @param content  content
     */
