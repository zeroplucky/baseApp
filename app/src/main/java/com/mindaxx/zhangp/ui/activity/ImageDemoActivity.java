...
public class ImageDemoActivity extends AppCompatActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    public void onItemClick(View view, int position) {
        switch (position) {
            case -1:
                ...
                Intent intent1 = new Intent(ImageDemoActivity.this, ImageGridActivity.class);
