 ...
 * <p>
 * Github https://github.com/qyxxjd/MultipleStatusView
 */
...
public class StatusView extends RelativeLayout {
    ...
    public StatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.StatusView_emptyView, R.layout.status_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.StatusView_errorView, R.layout.status_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.StatusView_loadingView, R.layout.status_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.StatusView_noNetworkView, R.layout.status_no_network_view);
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(R.id.empty_view);
    ...
    public void setContentId_(int layoutId) {
        if (mContentViewResId == NULL_RESOURCE_ID) {
            mContentViewResId = layoutId;
            showContent();
        }
    }
